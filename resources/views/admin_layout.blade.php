        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li><a href="{{URL::to('/manage-slider')}}">Liệt kê Ảnh QC</a></li>
                        <li><a href="{{URL::to('/add-slider')}}">Thêm Ảnh QC</a></li>
                    </ul>
                </li>
                ...
                @hasrole(['admin','author'])
                 <li class="sub-menu">
                    ...
                    <ul class="sub">
                         <li><a href="{{URL::to('/add-users')}}">Thêm Người dùng</a></li>
                        <li><a href="{{URL::to('/users')}}">Liệt kê Người dùng</a></li>
