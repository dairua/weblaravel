                    ...
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="position-center">
                                <form role="form" action="{{URL::to('/save-post')}}" method="POST" enctype="multipart/from-data">
                                    {{ csrf_field() }}
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea style="resize: none" rows="4" class="form-control" name="post_meta_keywords" id="exampleInputPassword1" placeholder="Mô tả danh mục"></textarea>
                                </div>
                                <div class="form-group">
