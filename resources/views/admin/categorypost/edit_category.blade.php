                            ...
                            <div class="position-center">
                                ...
                                <!-- <div class="form-group">
                                    <label for="exampleInputPassword1">Hiển thị</label>
                                        <select name="cate_post_status" value="{{$category_post->cate_post_status}}" class="form-control input-sm m-bot15">
                                ...
                                <button type="submit" name="edit_post_cate" class="btn btn-info">Cập nhật danh mục bài viết</button>
                                </form>
                            </div>
